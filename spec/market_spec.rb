...
RSpec.describe Market do
  ...
  describe "#vendor_names" do
    it "can list the name of all vendors at the market" do
      @market.add_vendor(@vendor1)
      @market.add_vendor(@vendor2)
      @market.add_vendor(@vendor3)
  ...
  describe "#potential_revenue" do
    it "can total the amount of money a vendor could expect to make based on price * quantity" do
      @vendor1.stock(@item1, 35)
      @vendor1.stock(@item2, 7)
  ...
  describe "#sorted_items_list" do
    it "can list an array of names of all items the vendors have in stock in alphabetical order" do
      @vendor1.stock(@item1, 35)
      @vendor1.stock(@item2, 7)
